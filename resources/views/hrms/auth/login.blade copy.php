...
<head>
    ...
    <!-- -------------- CSS - allcp forms -------------- -->
    <link rel="stylesheet" type="text/css" href="public/assets/allcp/forms/css/forms.css">
...
<!-- -------------- jQuery -------------- -->
<script src="public/assets/js/jquery/jquery-1.11.3.min.js"></script>
<script src="public/assets/js/jquery/jquery_ui/jquery-ui.min.js"></script>

<!-- -------------- CanvasBG JS -------------- -->
<script src="public/assets/js/plugins/canvasbg/canvasbg.js"></script>

<!-- -------------- Theme Scripts -------------- -->
<script src="public/assets/js/utility/utility.js"></script>
<script src="public/assets/js/demo/demo.js"></script>
