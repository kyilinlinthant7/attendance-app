                ...
                <div class="col-xs-12">
                    ...
                    <div class="panel">
                        <div class="panel-heading col-md-6">
                            <span class="panel-title hidden-xs" style="color:black">{{ $empStatus }} Employees List5</span><br />
                        </div>
                        ...
                        @if(count($emps) == 0)
                            <div>
                                <p class="text-center">There is no {{ $empStatus }} employees to show.</p>
                            </div>
                        @endif
                        ...
                        <div class="panel-body pn">
                                        ...
                                        @foreach ($emps as $emp)
                                            <tr class="bg-light" style="border: 1px solid #a7920c;">
                                                ...
                                                <td>
                                                    ...
                                                    <a href="/delete-emp/{{$emp->id}}" class="btn btn-danger" style="font-size: 10px;"><i class="fas fa-trash"></i></a>
                                                </td>
                                            </tr>
                                        @endforeach
                                    </tbody>
                            ...
                            <!--    @if (Auth::user()->isAdmin() || Auth::user()->isHR() || Auth::user()->isAssistantHrManager() || Auth::user()->isHrOfficerRecruit() || Auth::user()->isHrOfficerCompen() || Auth::user()->isHrER() || Auth::user()->isHrAssistant())-->
                            <!--        @foreach ($emps as $emp)-->
                            <!--            <div class="col-lg-3 col-md-5 col-12 bg-light" style="border: 1px solid #a7920c; border-radius: 5px; height: 140px; padding-top: 5px;"   onMouseOver="this.style.color='green'" onMouseOut="this.style.color='black'">-->
                                            <!-- HR's view -->
                            <!--                <div class="small-box primary">-->
                            <!--                    <div class="row">-->
                            <!--                        <div class="col-md-6">-->
                            <!--                            <div class="inner" style="float: left; padding-top: 5px;">-->
                            <!--                                <img src="@if ($emp->photo) {{ URL::asset('public/userimages/' . $emp->photo) }} @else {{ URL::asset('public/userimages/user.png') }} @endif" class="img-responsive emp-img" width="50" height="50" style="border-radius:40%;border:1px solid #000000">-->
                            <!--                                <h6 style="font-weight: 700">{{$emp->name}}</h6>-->
                            <!--                                <p style="font-size: 10px">{{$emp->employee_id}}</p>-->
                            <!--                                <?php -->
                            <!--                                    $date = new DateTime($emp->date_of_joining);-->
                            <!--                                    $formattedDate = $date->format('d/m/y');-->
                            <!--                                ?>-->
                            <!--                                <p style="font-size: 10px">Joined at {{$formattedDate}}</p>-->
                            <!--                            </div>-->
                            <!--                        </div>-->
                            <!--                        <div class="col">-->
                            <!--                            <div class="icon">-->
                            <!--                                <h5 style="font-weight: 700">{{$emp->position}}</h5>-->
                            <!--                                <p style="font-size: 10px">{{$emp->department}}</p>-->
                            <!--                                <p style="font-size: 10px">{{$emp->phone}}</p>-->
                            <!--                                <a href="view-emp/{{$emp->id}}" class="btn btn-primary" style="margin: 10px; width: 70px; height: 30px">View</a>-->
                            <!--                            </div>-->
                            <!--                        </div>-->
                            <!--                    </div>-->
                            <!--                </div>-->
                            ...
                            <!--    @else-->
                            <!--        @foreach ($emps as $emp)-->
                            <!--            @if ($emp->sub_department == 'Contract' || $emp->sub_department == 'Operation')-->
                            <!--                <div class="col-lg-3 col-md-5 col-12 bg-light" style="border: 1px solid #a7920c; border-radius: 5px; height: 140px; padding-top: 5px;"   onMouseOver="this.style.color='green'" onMouseOut="this.style.color='black'">-->
                                                <!-- Contract's view -->
                            <!--                    <div class="small-box primary">-->
                            <!--                        <div class="row">-->
