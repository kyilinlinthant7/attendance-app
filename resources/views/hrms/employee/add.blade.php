...
<!--            <div class="mw1000 center-block" style="margin-left:50px;margin-right: 300px" >-->
<!--                @if(session('message'))-->
<!--                    {{session('message')}}-->
<!--                @endif-->
...
<!--                                    <div class="section">-->
<!--                                        <label for="input002"><h6 class="mb20 mt40">Marital Status </h6></label>-->
...
<!--                                                       class="gui-input phone-group" value="@if($emps && $emps->employee->number){{$emps->employee->number}}@endif">-->
<!--                                                <label for="input002" class="field-icon">-->
...
<!--                                    <div class="section">-->
<!--                                        <label for="input002"><h6 class="mb20 mt40"> N.R.C No. </h6></label>-->
<!--                                        <label for="input002" class="field prepend-icon">-->
<!--                                            @if(\Route::getFacadeRoot()->current()->uri() == 'edit-emp/{id}')-->
...
<!--                                            @else-->
<!--                                                <input type="text" placeholder="NRC" name="pan_number"-->
...
<!--                                    </div>-->
                                    <!--mother name-->
<!--                                    <div class="section">-->
<!--                                        <label for="input002"><h6 class="mb20 mt40"> Mother's Name </h6></label>-->
<!--                                        <label for="input002" class="field prepend-icon">-->
<!--                                            @if(\Route::getFacadeRoot()->current()->uri() == 'edit-emp/{id}')-->
<!--                                                <input type="text" name="mother_name" id="mother_name" class="gui-input"-->
<!--                                                       value="@if($emps && $emps->employee->mother_name){{$emps->employee->mother_name}}@endif">-->

<!--                                            @else-->
<!--                                                <input type="text" placeholder="Employees' mother name"-->
<!--                                                       name="mother_name" id="mother_name" class="gui-input">-->
...
<!--                                                @if(\Route::getFacadeRoot()->current()->uri() == 'edit-emp/{id}')-->
<!--                                                    @if($emps->employee->department == 'BOD')-->
...
<!--                                                    <option value="MML_Service Operation">MML_Service Operation</option>-->
<!--                                                    <option value="Operation">Operation</option>-->
<!--                                                    <option value="Software">Software</option>-->
<!--                                                    <option value="Information/PR">Information/PR</option>-->
<!--                                                    @elseif($emps->employee->department == 'Admin/HR')-->
<!--                                                        <option value="BOD">BOD</option>-->
<!--                                                        <option value="Admin/HR" selected>Admin/HR</option>-->
<!--                                                        <option value="Finance & Account">Finance & Account</option>-->
<!--                                                        <option value="Strategic">Strategic</option>-->
<!--                                                    <option value="Production">Production</option>-->
<!--                                                    <option value="Business">Business</option>-->
...
<!--                                                    @elseif($emps->employee->department == 'Finance & Account')-->
<!--                                                        <option value="BOD">BOD</option>-->
<!--                                                        <option value="Admin/HR" >Admin/HR</option>-->
<!--                                                        <option value="Finance & Account" selected>Finance & Account</option>-->
<!--                                                        <option value="Strategic">Strategic</option>-->
<!--                                                    <option value="Production">Production</option>-->
<!--                                                    <option value="Business">Business</option>-->
<!--                                                    <option value="MML_Service Operation">MML_Service Operation</option>-->
...
<!--                                                    @elseif($emps->employee->department == 'Strategic')-->
<!--                                                        <option value="BOD">BOD</option>-->
<!--                                                        <option value="Admin/HR" >Admin/HR</option>-->
<!--                                                        <option value="Finance & Account">Finance & Account</option>-->
...
<!--                                                    <option value="Software">Software</option>-->
<!--                                                    <option value="Information/PR">Information/PR</option>-->
<!--                                                    @elseif($emps->employee->department == 'Production')-->
<!--                                                        <option value="BOD">BOD</option>-->
<!--                                                        <option value="Admin/HR" >Admin/HR</option>-->
<!--                                                        <option value="Finance & Account">Finance & Account</option>-->
<!--                                                        <option value="Strategic">Strategic</option>-->
...
<!--                                                    <option value="Software">Software</option>-->
<!--                                                    <option value="Information/PR">Information/PR</option>-->
<!--                                                    @elseif($emps->employee->department == 'Business')-->
<!--                                                        <option value="BOD">BOD</option>-->
<!--                                                        <option value="Admin/HR" >Admin/HR</option>-->
<!--                                                        <option value="Finance & Account">Finance & Account</option>-->
<!--                                                        <option value="Strategic">Strategic</option>-->
...
<!--                                                    <option value="Software">Software</option>-->
<!--                                                    <option value="Information/PR">Information/PR</option>-->
<!--                                                    @elseif($emps->employee->department == 'MML_Service Operation')-->
<!--                                                        <option value="BOD">BOD</option>-->
<!--                                                        <option value="Admin/HR" >Admin/HR</option>-->
<!--                                                        <option value="Finance & Account">Finance & Account</option>-->
<!--                                                        <option value="Strategic">Strategic</option>-->
<!--                                                    <option value="Production">Production</option>-->
<!--                                                    <option value="Business">Business</option>-->
<!--                                                    <option value="MML_Service Operation" selected>MML_Service Operation</option>-->
<!--                                                    <option value="Operation">Operation</option>-->
<!--                                                    <option value="Software">Software</option>-->
<!--                                                    <option value="Information/PR">Information/PR</option>-->
<!--                                                    @elseif($emps->employee->department == 'Operation')-->
<!--                                                        <option value="BOD">BOD</option>-->
<!--                                                        <option value="Admin/HR" >Admin/HR</option>-->
<!--                                                        <option value="Finance & Account">Finance & Account</option>-->
<!--                                                        <option value="Strategic">Strategic</option>-->
...
<!--                                                    <option value="Software">Software</option>-->
<!--                                                    <option value="Information/PR">Information/PR</option>-->
<!--                                                    @elseif($emps->employee->department == 'Software')-->
<!--                                                        <option value="BOD">BOD</option>-->
<!--                                                        <option value="Admin/HR" >Admin/HR</option>-->
<!--                                                        <option value="Finance & Account">Finance & Account</option>-->
<!--                                                        <option value="Strategic">Strategic</option>-->
...
<!--                                                    <option value="Operation">Operation</option>-->
<!--                                                    <option value="Software" selected>Software</option>-->
<!--                                                    <option value="Information/PR" selected>Information/PR</option>-->
<!--                                                    @endif-->
<!--                                                @else-->
<!--                                                    <option value="BOD">BOD</option>-->
<!--                                                    <option value="Admin/HR">Admin/HR</option>-->
...
<!--                                </section>-->
                                ...
                                <!-- -------------- step 3 -------------- -->
<!--                                <h4 class="wizard-section-title">-->
<!--                                    <i class="fa fa-file-text pr5"></i> Leave Details</h4>-->
<!--                                <section class="wizard-section">-->
                                    ...
                                    <!--for leave-->
<!--                                    <div class="section">-->
<!--                                        <label for="input002"><h6 class="mb20 mt40"> Causal Leave </h6></label>-->
<!--                                        <label for="input002" class="field prepend-icon">-->
<!--                                            @if(\Route::getFacadeRoot()->current()->uri() == 'edit-emp/{id}')-->
<!--                                                <input type="text" name="causal" id="causal"-->
<!--                                                       class="gui-input"-->
<!--                                                       value="@if($emps && $emps->employee->causal){{$emps->employee->causal}}@endif">-->
<!--                                                <label for="input002" class="field-icon">-->
<!--                                                    <i class="fa fa-list"></i>-->
<!--                                                </label>-->
<!--                                            @else-->
<!--                                                <input type="text" placeholder="Causal Leave"-->
<!--                                                       name="causal" id="causal" class="gui-input">-->
<!--                                                <label for="input002" class="field-icon">-->
<!--                                                    <i class="fa fa-list"></i>-->
<!--                                                </label>-->
<!--                                            @endif-->
...
<!--                                    </div>-->
<!--                                    <div class="section">-->
<!--                                        <label for="input002"><h6 class="mb20 mt40"> Earned Leave </h6></label>-->
<!--                                        <label for="input002" class="field prepend-icon">-->
<!--                                            @if(\Route::getFacadeRoot()->current()->uri() == 'edit-emp/{id}')-->
<!--                                                <input type="text" name="earned" id="earned"-->
<!--                                                       class="gui-input"-->
<!--                                                       value="@if($emps && $emps->employee->earned){{$emps->employee->earned}}@endif">-->
<!--                                                <label for="input002" class="field-icon">-->
<!--                                                    <i class="fa fa-list"></i>-->
<!--                                                </label>-->
<!--                                            @else-->
<!--                                                <input type="text" placeholder="Earned Leave"-->
<!--                                                       name="earned" id="earned" class="gui-input">-->
<!--                                                <label for="input002" class="field-icon">-->
<!--                                                    <i class="fa fa-list"></i>-->
<!--                                                </label>-->
<!--                                            @endif-->
...
<!--                                    </div>-->
<!--                                    <div class="section">-->
<!--                                        <label for="input002"><h6 class="mb20 mt40"> Medical Leave </h6></label>-->
<!--                                        <label for="input002" class="field prepend-icon">-->
<!--                                            @if(\Route::getFacadeRoot()->current()->uri() == 'edit-emp/{id}')-->
<!--                                                <input type="text" name="medical" id="medical"-->
<!--                                                       class="gui-input"-->
<!--                                                       value="@if($emps && $emps->employee->medical){{$emps->employee->medical}}@endif">-->
<!--                                                <label for="input002" class="field-icon">-->
<!--                                                    <i class="fa fa-list"></i>-->
<!--                                                </label>-->
<!--                                            @else-->
<!--                                                <input type="text" placeholder="Medical Leave"-->
<!--                                                       name="medical" id="medical" class="gui-input">-->
<!--                                                <label for="input002" class="field-icon">-->
<!--                                                    <i class="fa fa-list"></i>-->
<!--                                                </label>-->
<!--                                            @endif-->
...
<!--                                    </div>-->
<!--                                    <div class="section">-->
<!--                                        <label for="input002"><h6 class="mb20 mt40"> Maternity Leave </h6></label>-->
<!--                                        <label for="input002" class="field prepend-icon">-->
<!--                                            @if(\Route::getFacadeRoot()->current()->uri() == 'edit-emp/{id}')-->
<!--                                                <input type="text" name="maternity" id="maternity"-->
<!--                                                       class="gui-input"-->
<!--                                                       value="@if($emps && $emps->employee->maternity){{$emps->employee->maternity}}@endif">-->
<!--                                                <label for="input002" class="field-icon">-->
<!--                                                    <i class="fa fa-list"></i>-->
<!--                                                </label>-->
<!--                                            @else-->
<!--                                                <input type="text" placeholder="Maternity Leave"-->
<!--                                                       name="maternity" id="maternity" class="gui-input">-->
<!--                                                <label for="input002" class="field-icon">-->
<!--                                                    <i class="fa fa-list"></i>-->
<!--                                                </label>-->
<!--                                            @endif-->
...
<!--                                    </div>-->
<!--                                    <div class="section">-->
<!--                                        <label for="input002"><h6 class="mb20 mt40"> Paternity Leave </h6></label>-->
<!--                                        <label for="input002" class="field prepend-icon">-->
<!--                                            @if(\Route::getFacadeRoot()->current()->uri() == 'edit-emp/{id}')-->
<!--                                                <input type="text" name="paternity" id="paternity"-->
<!--                                                       class="gui-input"-->
<!--                                                       value="@if($emps && $emps->employee->paternity){{$emps->employee->paternity}}@endif">-->
<!--                                                <label for="input002" class="field-icon">-->
<!--                                                    <i class="fa fa-list"></i>-->
<!--                                                </label>-->
<!--                                            @else-->
<!--                                                <input type="text" placeholder="Paternity Leave"-->
<!--                                                       name="paternity" id="paternity" class="gui-input">-->
<!--                                                <label for="input002" class="field-icon">-->
<!--                                                    <i class="fa fa-list"></i>-->
<!--                                                </label>-->
<!--                                            @endif-->
...
<!--                                    </div>-->
<!--                                    <div class="section">-->
<!--                                        <label for="input002"><h6 class="mb20 mt40"> Compassionate Leave </h6></label>-->
<!--                                        <label for="input002" class="field prepend-icon">-->
<!--                                            @if(\Route::getFacadeRoot()->current()->uri() == 'edit-emp/{id}')-->
<!--                                                <input type="text" name="compassionate" id="compassionate"-->
<!--                                                       class="gui-input"-->
<!--                                                       value="@if($emps && $emps->employee->compassionate){{$emps->employee->compassionate}}@endif">-->
<!--                                                <label for="input002" class="field-icon">-->
<!--                                                    <i class="fa fa-list"></i>-->
<!--                                                </label>-->
<!--                                            @else-->
<!--                                                <input type="text" placeholder="Compassionate Leave"-->
<!--                                                       name="compassionate" id="compassionate" class="gui-input">-->
<!--                                                <label for="input002" class="field-icon">-->
<!--                                                    <i class="fa fa-list"></i>-->
<!--                                                </label>-->
<!--                                            @endif-->
...
<!--                                    </div>-->
<!--                                    <div class="section">-->
<!--                                        <label for="input002"><h6 class="mb20 mt40"> Marriage Leave </h6></label>-->
<!--                                        <label for="input002" class="field prepend-icon">-->
<!--                                            @if(\Route::getFacadeRoot()->current()->uri() == 'edit-emp/{id}')-->
<!--                                                <input type="text" name="marriage" id="marriage"-->
<!--                                                       class="gui-input"-->
<!--                                                       value="@if($emps && $emps->employee->marriage){{$emps->employee->marriage}}@endif">-->
<!--                                                <label for="input002" class="field-icon">-->
<!--                                                    <i class="fa fa-list"></i>-->
<!--                                                </label>-->
<!--                                            @else-->
<!--                                                <input type="text" placeholder="Marriage Leave"-->
<!--                                                       name="marriage" id="marriage" class="gui-input">-->
<!--                                                <label for="input002" class="field-icon">-->
<!--                                                    <i class="fa fa-list"></i>-->
<!--                                                </label>-->
<!--                                            @endif-->
...
<!--                                    </div>-->
<!--                                    <div class="section">-->
<!--                                        <label for="input002"><h6 class="mb20 mt40"> Leave Without Pay </h6></label>-->
<!--                                        <label for="input002" class="field prepend-icon">-->
<!--                                            @if(\Route::getFacadeRoot()->current()->uri() == 'edit-emp/{id}')-->
<!--                                                <input type="text" name="withoutpay" id="withoutpay"-->
<!--                                                       class="gui-input"-->
<!--                                                       value="@if($emps && $emps->employee->withoutpay){{$emps->employee->withoutpay}}@endif">-->
<!--                                                <label for="input002" class="field-icon">-->
<!--                                                    <i class="fa fa-list"></i>-->
<!--                                                </label>-->
<!--                                            @else-->
<!--                                                <input type="text" placeholder="Leave Without Pay"-->
<!--                                                       name="withoutpay" id="withoutpay" class="gui-input">-->
<!--                                                <label for="input002" class="field-icon">-->
<!--                                                    <i class="fa fa-list"></i>-->
<!--                                                </label>-->
<!--                                            @endif-->
