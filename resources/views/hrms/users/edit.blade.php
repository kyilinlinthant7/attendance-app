                    ...
                    <div class="box box-success">
                        <div class="panel">
                            <div class="panel-heading text-center">
                                <span class="panel-title hidden-xs" style="color: black"> Edit User </span>
                            </div>
                            ...
                            <div class="panel-body pn">
                                <div class="table-responsive">
                                    <div class="panel-body p25 pb10">
                                        ...
                                        @endif
                                        {!! Form::open(array('url' =>array('/update-user' ,$users->id) ,'class'=>'form-horizontal',"enctype"=>"multipart/form-data")) !!}
                                        ...
                                        <div class="form-group">
                                                ...
                                                <div class="col-md-6">
                                                <select name="name" id="name"  class="select2-multiple form-control select-primary">
                                        ...
                                        <div class="form-group">
                                            ...
                                            <div class="col-md-6">
                                                <input type="text" name="password" id="password"
                                                    class="select2-single form-control" placeholder="Password"
                                                    required readonly>
                                            </div>
                                            <div class="col md-3">
                                        ...
                                        <div class="form-group">
                                            ...
                                            <div class="col-md-2"><a href="/edit-user" style="text-decoration: none">
                                                    <input type="button"
