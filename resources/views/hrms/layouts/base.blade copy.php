...
<head>
    ...
    <link rel="stylesheet" type="text/css"  href="{{URL::asset('public/assets/allcp/forms/css/forms.css')}}">
     ...
     <link rel="stylesheet" type="text/css" href="{{ URL::asset('public/assets/js/plugins/c3charts/c3.min.css') }}">
  
    <link rel="stylesheet" type="text/css" href="{{ URL::asset('public/assets/js/plugins/magnific/magnific-popup.css') }}">
    <!-- Scripts -->
    ...
    <!--  Custom css -->
    <link rel="stylesheet" type="text/css" href="{{ URL::asset('public/assets/custom.css') }}">
...
<script src="{{ URL::asset('public/assets/js/jquery/jquery-2.2.4.min.js') }}"></script> --}}
<script src="{{ URL::asset('public/assets/js/jquery/jquery_ui/jquery-ui.min.js') }}"></script>


<script src="{{ URL::asset('public/assets/js/plugins/c3charts/c3.min.js') }}"></script>
<script src="{{ URL::asset('public/assets/js/plugins/c3charts/d3.min.js') }}"></script>
<script src="{{ URL::asset('public/assets/js/plugins/magnific/jquery.magnific-popup.js') }}"></script>
<script src="{{ URL::asset('public/assets/js/plugins/magnific/jquery.magnific-popup.min.js') }}"></script>

<!-- -------------- FullCalendar Plugin -------------- -->
<script src="{{ URL::asset('public/assets/js/plugins/fullcalendar/lib/moment.min.js') }}"></script>
<script src="{{ URL::asset('public/assets/js/plugins/fullcalendar/fullcalendar.min.js') }}"></script>

<!-- -------------- Date/Month - Pickers -------------- -->
<script src="{{ URL::asset('public/assets/allcp/forms/js/jquery-ui-monthpicker.min.js') }}"></script>
<script src="{{ URL::asset('public/assets/allcp/forms/js/jquery-ui-datepicker.min.js') }}"></script>
...
<!-- -------------- Widget JS -------------- -->
<script src="{{ URL::asset('public/assets/js/demo/widgets.js') }}"></script>
<script src="{{ URL::asset('public/assets/js/demo/widgets_sidebar.js') }}"></script>
<script src="{{ URL::asset('public/assets/js/pages/dashboard1.js') }}"></script>




<script src="{{URL::asset('public/assets/allcp/forms/js/jquery.spectrum.min.js')}}"></script>
<script  src="{{URL::asset('public/assets/allcp/forms/js/jquery.validate.min.js')}}"></script>
<script  src="{{URL::asset('public/assets/allcp/forms/js/jquery.stepper.min.js')}}" ></script>

<script  src="{{URL::asset('public/assets/allcp/forms/js/jquery.steps.min.js')}}" ></script>
<script src="{{URL::asset('public/assets/js/emp_wiz_latest.js')}}"></script>
<script src="{{URL::asset('public/assets/js/pages/forms-widgets.js')}}"></script>
